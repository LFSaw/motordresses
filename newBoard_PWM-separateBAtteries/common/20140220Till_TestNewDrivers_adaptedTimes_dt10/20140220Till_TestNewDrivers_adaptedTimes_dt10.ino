const int speeds[2][2] = {{85, 225}, {155, 205}}; // [50..255]

// set times for each movement (in milliseconds)
// [initDelta, upTime, breakTime, downTime]
const int times[2][2][4] = {
	{
		{  3,   350,  80,  349},  // back  0 (BL) B1
		{  300,  500, 120,   500} // front 1 (FU) A1
	},
	{
		{  110,  300, 110, 300},  // back  1 (BU) B2
		{  3,  380, 100, 375} // front 0 (FL) A2
	}
};
